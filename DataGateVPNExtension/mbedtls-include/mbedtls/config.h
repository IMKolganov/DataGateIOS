...
// NOTE: Default MPI_MAX_SIZE should be sufficient for RSA-2048 (257 bytes for modulus),
// but if you see MBEDTLS_ERR_PK_INVALID_PUBKEY errors, it might be masking MPI_ALLOC_FAILED.
// See: https://github.com/Mbed-TLS/mbedtls/issues/3688
